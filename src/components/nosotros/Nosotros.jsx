...
const Nosotros = () => {
    ...
    const galeria = [
        { id: 1, foto: fotoRedondo },
        { id: 2, foto: fotoRedondo },
        { id: 3, foto: fotoRedondo },
        { id: 4, foto: fotoRedondo },
        { id: 5, foto: fotoRedondo },
        { id: 6, foto: fotoRedondo },
    ];

    return (
        <>

            <section className="nosotros-container-informacion">
                ...
                <div className="fotos">
                    {
                        galeria.map((galeria, index) => {
                            return <img key={index} src={galeria.foto} alt="Foto" className="foto" />
                        })
                    }
                </div>
            </section>
